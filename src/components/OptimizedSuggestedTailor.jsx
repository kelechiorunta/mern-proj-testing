        ...
        <div className="flex flex-col px-6 w-full max-md:px-5 max-md:max-w-full">
          <div className="flex gap-2 max-md:flex-wrap">
            <img alt="Replace with an informative alt text" 
              ...
              loading="lazy"
              src="/ae066e8ca0e9538445b9a86f5b9d70f31ddfdca2e9020efb93365e7fae2a9faf.png" 
            ...
            <div className="flex items-center justify-end gap-x-[100px] container max-w-[80%] py-2.5 pr-5 pl-20 bg-red-500 rounded-md max-md:pl-5">
              <div className="flex overflow-hidden relative items-center justify-center rounded-full w-[72px] h-[72px]">
                <img alt="Replace with an informative alt text" 
                  sizes="100w, 200w, 400w, 800w, 1200w, 1600w, 2000w"
                  loading="lazy"
                  src="/bd342aa9e60c1ac13d5357faba0f87d1382e294fbb0779c3d6e7d783b7158128.png" 
                  width={1000} height={1000}
              ...
              <div className="flex relative items-center justify-center rounded-full w-[72px] h-[72px]">
                <img alt="Replace with an informative alt text" 
                  sizes="100w, 200w, 400w, 800w, 1200w, 1600w, 2000w"
                  loading="lazy"
                  src="/8b74e9411b1b1f690dc9c8911d197750848138827f7022a22cfb59ac21245187.png" 
                  width={1000} height={1000}
          ...
          <div className="flex flex-wrap gap-3.5 self-end mt-4 w-full max-w-[1083px] max-md:max-w-full">
            ...
            <div className="container max-w-[80%] flex flex-wrap flex-auto gap-10 justify-center items-center px-2.5 py-3.5 text-sm rounded border border-black border-solid min-h-[64px] text-zinc-400 max-md:max-w-full">
              <div className="flex gap-3 justify-center items-center self-stretch my-auto">
                <img alt="Replace with an informative alt text"
                  loading="lazy"
                  src="/87a8b61e89d4da06c4794769716dd173d96812cd0e2e1a32706250c891ba6cd0.svg" 
                  width={30} height={30}
              ...
              <div className="flex gap-3 justify-center items-center self-stretch px-2 my-auto border-l border-black">
                <img alt="Replace with an informative alt text" 
                  sizes="100w, 200w, 400w, 800w, 1200w, 1600w, 2000w"
                  loading="lazy"
                  src="/3ea36f48ee19db4694009d4980bfd48a4e084d8fa963613d0acacfb6330188e2.png" 
                  width={1000} height={1000}
                  className="object-contain shrink-0 self-stretch my-auto aspect-square w-[30px]"
                />
                ...
                <img alt="Replace with an informative alt text"
                  loading="lazy"
                  src="/f34e1faae923cbb3cc6ffac85472990018e1da854cd952d43d9cdbf27bf9cbbc.svg" 
                  width={18} height={18}
              ...
              <div className="flex gap-3 justify-center items-center self-stretch px-2 my-auto border-l border-black">
                <img alt="Replace with an informative alt text" 
                  sizes="100w, 200w, 400w, 800w, 1200w, 1600w, 2000w"
                  loading="lazy"
                  src="/ae781884ea0ea3371a053457ae18e25b069ab391aaad4274ccb40a31bd00de0e.png" 
                  width={1000} height={1000}
                  className="object-contain shrink-0 self-stretch my-auto aspect-square w-[30px]"
                />
              ...
              <div className="flex flex-col w-full text-base font-medium text-center text-teal-900 max-md:mt-10">
                <div className="flex flex-col items-start pr-12 pl-4 w-full max-md:pr-5">
                  <button className="flex gap-3 whitespace-nowrap w-full -ml-4 -mb-3.5 hover:bg-red-400 px-4 py-3.5 rounded-md hover:text-white hover:transition-all duration-500 ease-in-out">
                    <img alt="Replace with an informative alt text"
                      loading="lazy"
                      src="/0cf49daeab220e681877aab771a91450a19bc6cda4a7b25a8d598f2685f7b815.svg" 
                      width={20} height={20}
                  ...
                  {/* className="flex gap-3 mt-9"> */}
                    <img alt="Replace with an informative alt text"
                      loading="lazy"
                      src="/67a13b91c5bcfa0108b559439cce6dbdb0bd335533ff3a28b77a2c9ef4ecb8c7.svg" 
                      width={20} height={20}
                  ...
                  {/* className="flex gap-3 mt-8 whitespace-nowrap"> */}
                    <img alt="Replace with an informative alt text"
                      loading="lazy"
                      src="/7f7a84b9af77f45e9a96be63ecb0e674b951e2b8e3fc928da593140d5b0bb6a2.svg" 
                      width={20} height={20}
                      className="object-contain shrink-0 my-auto w-5 aspect-square"
                    />
                    <div>Orders</div>
                ...
                <div className="flex gap-3 px-4 py-3.5 mt-6 text-white bg-red-500 rounded-md">
                  <img alt="Replace with an informative alt text"
                    loading="lazy"
                    src="/5264666884ae38448ad1793f76388abf93a3b5501a6f4bf051157a90195fe2b8.svg" 
                    width={22} height={16}
                ...
                <div className="flex flex-col items-start mt-5 ml-4 max-w-full w-[140px] max-md:ml-2.5">
                  ...
                  {/* className="flex gap-3 self-stretch"> */}
                    <img alt="Replace with an informative alt text"
                      loading="lazy"
                      src="/b008e611690ffbeadc4ee28348e8b1194f57b84361beb34b405b8f4808ddd1d6.svg" width={20} height={20}
                      className="object-contain shrink-0 self-start mt-1 w-5 aspect-square"
                    />
                  ...
                  {/* // className="flex gap-3 mt-8 whitespace-nowrap"> */}
                    <img alt="Replace with an informative alt text"
                      loading="lazy"
                      src="/3babca392b4e7f87c325e882d76c12a37355f767b54d9148a1005f5d25ddb195.svg" width={20} height={20}
                      className="object-contain shrink-0 self-start mt-1 w-5 aspect-square"
                    />
                    <div>Support</div>
                  </button>
                  ...
                  {/* className="flex gap-3.5 mt-8 whitespace-nowrap"> */}
                    <img alt="Replace with an informative alt text"
                      loading="lazy"
                      src="/25162f4bb779e6e52943687541ddb9484a8c9215a6add02bb36738da1e3801dd.svg" width={16} height={19}
